...
EXPORT_FUNC void pushMergedNeuronInitGroup1ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* m, scalar* r, scalar* theta, scalar* a, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronInitGroup2ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* m, scalar* r, scalar* theta, scalar* a, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronInitGroup3ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn0, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn3, float* inSynInSyn3, unsigned int* denDelayPtrInSyn2, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* denDelayInSyn1, float* inSynInSyn1, float* denDelayInSyn0, float* inSynInSyn0, scalar* a, scalar* theta, scalar* r, scalar* m, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronInitGroup4ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* m, scalar* r, scalar* theta, scalar* a, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronInitGroup7ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* r, scalar* input, unsigned int numNeurons);
EXPORT_FUNC void pushMergedSynapseInitGroup0ToDevice(unsigned int idx, scalar* w, bool* active, uint8_t* delay, unsigned int rowStride, unsigned int numSrcNeurons, unsigned int numTrgNeurons, scalar constantdelay);
EXPORT_FUNC void pushMergedNeuronUpdateGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* m, scalar* r, scalar* theta, scalar* a, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronUpdateGroup2ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn0, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn3, float* inSynInSyn3, unsigned int* denDelayPtrInSyn2, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* denDelayInSyn1, float* inSynInSyn1, float* denDelayInSyn0, float* inSynInSyn0, scalar* a, scalar* theta, scalar* r, scalar* m, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronUpdateGroup3ToDevice(unsigned int idx, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn4, float* denDelayInSyn4, float* inSynInSyn4, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn3, float* inSynInSyn3, unsigned int* denDelayPtrInSyn2, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* inSynInSyn1, unsigned int* denDelayPtrInSyn0, float* denDelayInSyn0, float* inSynInSyn0, scalar* a, scalar* theta, scalar* r, scalar* m, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons);
EXPORT_FUNC void pushMergedNeuronUpdateGroup4ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn0, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn3, float* inSynInSyn3, unsigned int* denDelayPtrInSyn2, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* denDelayInSyn1, float* inSynInSyn1, float* denDelayInSyn0, float* inSynInSyn0, scalar* a, scalar* theta, scalar* r, scalar* m, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronUpdateGroup8ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* r, scalar* input, unsigned int numNeurons);
EXPORT_FUNC void pushMergedSynapseDynamicsGroup0ToDevice(unsigned int idx, float* denDelay, unsigned int* denDelayPtr, scalar* rPre, scalar* w, bool* active, uint8_t* delay, unsigned int rowStride, unsigned int numSrcNeurons, unsigned int numTrgNeurons);
EXPORT_FUNC void pushMergedSynapseDynamicsGroup1ToDevice(unsigned int idx, float* denDelay, unsigned int* denDelayPtr, scalar* rPre, scalar* w, bool* active, uint8_t* delay, unsigned int rowStride, unsigned int numSrcNeurons, unsigned int numTrgNeurons);
EXPORT_FUNC void pushMergedSynapseDynamicsGroup2ToDevice(unsigned int idx, float* denDelay, unsigned int* denDelayPtr, scalar* rPre, scalar* w, bool* active, uint8_t* delay, unsigned int rowStride, unsigned int numSrcNeurons, unsigned int numTrgNeurons);
...
EXPORT_FUNC void pushMergedSynapseDendriticDelayUpdateGroup1ToDevice(unsigned int idx, unsigned int* denDelayPtr);
EXPORT_FUNC void pushMergedSynapseDendriticDelayUpdateGroup2ToDevice(unsigned int idx, unsigned int* denDelayPtr);
}  // extern "C"
